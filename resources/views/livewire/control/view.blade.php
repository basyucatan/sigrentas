...
<div class="cardPrin" style="height: 75vh;">
    ...
    <div class="cardPrin-body" style="font-size: 1.2 rem;">
        @include('livewire.control.modals')
        <div class="row">
            <div class="col-6 col-md-4">
                <select wire:model.live="IdCasaFiltro" class="inpSolo">
            ...
            <div class="col-6 col-md-4">
                <select wire:model.live="estatusFiltro" class="inpSolo">
            ...
            <div class="col-6 col-md-4">
                <select wire:model.live="prioridadFiltro" class="inpSolo">
            ...
            <div class="col-6 col-md-4">
                <select wire:model.live="IdTecnicoFiltro" class="inpSolo">
                    ...
                    <div class="row g-2">
                        <div class="col-6 small">
                            ...
                            <span class="fw-bold text-uppercase">
                                {{ $item->cuarto->casa->casa ?? 'N/A' }}-{{ $item->cuarto->cuarto ?? 'N/A' }}
                            </span>
