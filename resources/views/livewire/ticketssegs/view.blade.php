        ...
        <div class="col-12">
            <div class="cardPrin">
                <div class="cardPrin-header" style="cursor: move;">
                    ...
                    <div>
                        <button class="bot botVerde" wire:click="create" title="Nuevo Ticketsseg">
                ...
                <div class="cardPrin-body">    
                    ...
                    @include('livewire.ticketssegs.modals')
                    <div class="tablaCont">
