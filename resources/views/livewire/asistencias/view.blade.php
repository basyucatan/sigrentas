            ...
            <div class="col-12 col-md-4">
                <div class="cardSec mb-3">
                    ...
                    <div class="cardSec-body text-center">
                        ...
                        <div class="d-flex gap-2 justify-content-center">
                            ...
                            <button class="bot botVerde botChico" wire:click="imprimirNomina" wire:loading.attr="disabled" wire:target="imprimirNomina" title="Imprimir nómina">
                ...
                <div class="cardSec mb-3" x-data="{ verMapa: true }">
                    <div class="cardSec-header d-flex justify-content-between align-items-center">
                        ...
                        <button type="button" class="bot botNegro botChico" @click="verMapa = !verMapa; $nextTick(() => { if(verMapa && mapa) mapa.invalidateSize(); })">
