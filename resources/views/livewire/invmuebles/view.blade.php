        ...
        <div class="col-12">
            <div class="cardPrin">
                <div class="cardPrin-header" style="cursor: move;">
                    ...
                    <div>
                        <button class="bot botVerde" wire:click="create" title="Nuevo Invmueble">
                ...
                <div class="cardPrin-body">    
                    ...
                    @include('livewire.invmuebles.modals')
                    <div class="tablaCont">
