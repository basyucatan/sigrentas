        ...
        <div class="col-12">
            <div class="cardPrin">
                <div class="cardPrin-header" style="cursor: move;">
                    ...
                    <div>
                        <button class="bot botVerde" wire:click="create" title="Nuevo Pena">
...
<th>Acciones</th></tr>
                            ...
                            <tbody>
                                @forelse($penas as $row)
                                    <tr>
                                        
								<td>{{ $row->pena }}</td>
								<td>{{ $row->descuentoDias }}</td>
