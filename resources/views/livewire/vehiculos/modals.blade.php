            ...
            <div class="modal-content">
                <div class="cardPrin">
                    <div class="cardPrin-header" style="cursor: move;">
                        <span>{{ $selected_id ? 'Editar Vehiculo' : 'Crear Vehiculo' }}</span>
                    </div>
...
<div class="col-md-6">
    <label class="etiBase">Vehiculo</label>
    <input wire:model="vehiculo" type="text" class="inpBase" onfocus="this.select()">
    @error('vehiculo') <span class="error text-danger">{{ $message }}</span> @enderror
</div>
<div class="col-md-6">
