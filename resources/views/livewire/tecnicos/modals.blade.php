            ...
            <div class="modal-content">
                <div class="cardPrin">
                    <div class="cardPrin-header" style="cursor: move;">
                        <span>{{ $selected_id ? 'Editar Tecnico' : 'Crear Tecnico' }}</span>
                    </div>
...
<div class="col-md-6">
    <label class="etiBase">Idvehiculo</label>
    <input wire:model="IdVehiculo" type="text" class="inpBase" onfocus="this.select()">
    @error('IdVehiculo') <span class="error text-danger">{{ $message }}</span> @enderror
</div>
<div class="col-md-6">
    <label class="etiBase">Tecnico</label>
    <input wire:model="tecnico" type="text" class="inpBase" onfocus="this.select()">
    @error('tecnico') <span class="error text-danger">{{ $message }}</span> @enderror
</div>
<div class="col-md-6">
